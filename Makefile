...
# Source Files
MAIN_DOC       := docs/architecture.md
SOURCE_DOCS    := $(MAIN_DOC)
...
pdf :
	@mkdir -p $(BUILD_DIR)/pdf
	$(PANDOC) $(PANDOC_OPTIONS) $(PANDOC_PDF_OPTIONS) -M subtitle="Operational, Security, Product and Architecture Specifications of the white label application" -o $(BUILD_DIR)/pdf/architecture-and-reference-framework-main-and-annexes.pdf $(SOURCE_DOCS)
